...
# | AI: Written by Claude (reviewed)                                          |
# +----------------------------------------------------------------------------+

# AI Generated -- PEP 723 dependency block, Script import/describe/@setup
# tags below added by Claude (Anthropic), 2026-09, bringing this script
# onto the @Script schema (see docs/notes/scripts_measurements_plotting.md
# §A.5 and expframework/script.py). Everything else in this file --
# analysis, export, stream setup -- is unchanged.
# /// script
# dependencies = [
#   "numpy",
#   "pandas",
...
Script.describe(  # AI Generated
	"Cell counting and growth-curve analysis: log colony counts and media "
	"additions, fit dilution-compensated exponential growth, export results."
)
